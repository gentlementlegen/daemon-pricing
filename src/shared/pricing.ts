import { Decimal } from "npm:decimal.js@^10.4.3"; // Add npm: and version specifier
import { determinePriorityOrder, extractLabelPattern } from "../handlers/label-checks.ts"; // Add .ts extension
